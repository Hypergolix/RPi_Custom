...
# importing the required libraries sd
...
creds = ServiceAccountCredentials.from_json_keyfile_name('ServiceAccountHere.json', scope)
...
if (A1old != A1 or A2old != A2 or A3old != A3 or A4old != A4 or A5old != A5 or A6old != A6 or A7old != A7 or A8old != A8 or A9old != A9 or A10old != A10 or A11old != A11 or A12old != A12 or A13old != A13 or A14old != A14 or A15old != A15):
    ...
    draw.text((2, 0), A1, font = font18, fill = 0)
    draw.text((2, 50), A2, font = font18, fill = 0)
    draw.text((2, 100), A3, font = font18, fill = 0)
    draw.text((2, 150), A4, font = font18, fill = 0)
    draw.text((2, 200), A5, font = font18, fill = 0)
    draw.text((2, 250), A6, font = font18, fill = 0)
    draw.text((2, 300), A7, font = font18, fill = 0)
    draw.text((2, 180), A8, font = font18, fill = 0)
    draw.text((2, 400), A9, font = font18, fill = 0)
    draw.text((2, 450), A10, font = font18, fill = 0)
    draw.text((2, 500), A11, font = font18, fill = 0)
    draw.text((2, 550), A12, font = font18, fill = 0)
    draw.text((2, 600), A13, font = font18, fill = 0)
    draw.text((2, 650), A14, font = font18, fill = 0)
    draw.text((2, 700), A15, font = font18, fill = 0)
